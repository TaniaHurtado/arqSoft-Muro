...
public class eliminarPublicacion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Publicacion publicacion =  nuevaPublicacion.eliminarPublicacion(idPub);
            System.out.println("encontro publicacion en servlet para eliminar" + publicacion);
            if (publicacion != null) {
                response.sendRedirect("principal.jsp");
                
            } else {
                out.println("<p>La publicacion no pudo ser eliminada. </p>");
            }
        }
    }
