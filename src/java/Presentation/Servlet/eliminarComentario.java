...
public class eliminarComentario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            Integer idCom = Integer.valueOf(request.getParameter("idCom").toString()); 
            System.out.println(" id comentario " + idCom);
            ManejoComentario mc = new ManejoComentario();
            Comentario comentario =  mc.eliminarComentario(idCom);
            System.out.println("encontro comentario en servlet para eliminar" + comentario);
            if (comentario != null) {
                response.sendRedirect("principal.jsp");
                
            } else {
                out.println("<p>El comentario no pudo ser eliminada. </p>");
            }
        }
    }
